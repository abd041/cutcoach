  ...
  return (
    ...
    >
      <Container className="section-py relative overflow-visible">
        ...
        <AudienceModeTransition variant="slide" className="faq-shell mx-auto mt-10 max-w-3xl overflow-hidden rounded-[1.35rem] p-px sm:mt-12 sm:rounded-[1.5rem]">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="focus-premium group flex min-h-11 w-full items-start justify-between gap-4 px-4 py-5 text-left sm:gap-6 sm:px-6 sm:py-6 lg:py-7"
